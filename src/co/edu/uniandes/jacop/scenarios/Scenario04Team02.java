...
public class Scenario04Team02 {
	public void solveProblem() {
		...
		BooleanVar mantenimiento = new BooleanVar(store, "mantenimiento");
		store.impose(new XeqC(mantenimiento, 1));
		BooleanVar modelodeseleccion = new BooleanVar(store, "modelodeseleccion");
		store.impose(new XeqC(modelodeseleccion, 1));
		...
		BooleanVar contratoconelproveedor = new BooleanVar(store, "contratoconelproveedor");
		store.impose(new XeqC(contratoconelproveedor, 0));
		BooleanVar contratoconunproveedorespecializado = new BooleanVar(store, "contratoconunproveedorespecializado");
		store.impose(new XeqC(contratoconunproveedorespecializado, 0));
		BooleanVar mantenimientoporcuentapropia = new BooleanVar(store, "mantenimientoporcuentapropia");
		BooleanVar sincontratodemantenimiento = new BooleanVar(store, "sincontratodemantenimiento");
		store.impose(new XeqC(sincontratodemantenimiento, 0));
		BooleanVar rfp_requestforproposal = new BooleanVar(store, "rfp_requestforproposal");
		BooleanVar consultoriaexterna = new BooleanVar(store, "consultoriaexterna");
		store.impose(new XeqC(consultoriaexterna, 0));
		BooleanVar evaluacioninterna = new BooleanVar(store, "evaluacioninterna");
		store.impose(new XeqC(evaluacioninterna, 0));

		// FEATURE ATTRIBUTES (Variables & Domains)
		IntVar[][] featureAttributes = new IntVar[36][4];featureAttributes[0][0] = new IntVar(store, "segmentarydepurarclientescostos", 0, 0);
		...
		featureAttributes[29][0] = new IntVar(store, "contratoconelproveedorcostos", 0, 800);
		featureAttributes[29][1] = new IntVar(store, "contratoconelproveedortiempo", 0, 0);
		featureAttributes[29][2] = new IntVar(store, "contratoconelproveedorrecursoshumanos", 0, 0);
		featureAttributes[29][3] = new IntVar(store, "contratoconelproveedorriesgos", 0, 26);

		featureAttributes[30][0] = new IntVar(store, "contratoconunproveedorespecializadocostos", 0, 950);
		featureAttributes[30][1] = new IntVar(store, "contratoconunproveedorespecializadotiempo", 0, 0);
		featureAttributes[30][2] = new IntVar(store, "contratoconunproveedorespecializadorecursoshumanos", 0, 0);
		featureAttributes[30][3] = new IntVar(store, "contratoconunproveedorespecializadoriesgos", 0, 59);

		featureAttributes[31][0] = new IntVar(store, "mantenimientoporcuentapropiacostos", 0, 500);
		featureAttributes[31][1] = new IntVar(store, "mantenimientoporcuentapropiatiempo", 0, 0);
		featureAttributes[31][2] = new IntVar(store, "mantenimientoporcuentapropiarecursoshumanos", 0, 0);
		featureAttributes[31][3] = new IntVar(store, "mantenimientoporcuentapropiariesgos", 0, 27);

		featureAttributes[32][0] = new IntVar(store, "sincontratodemantenimientocostos", 0, 0);
		featureAttributes[32][1] = new IntVar(store, "sincontratodemantenimientotiempo", 0, 0);
		featureAttributes[32][2] = new IntVar(store, "sincontratodemantenimientorecursoshumanos", 0, 0);
		featureAttributes[32][3] = new IntVar(store, "sincontratodemantenimientoriesgos", 0, 82);

		featureAttributes[33][0] = new IntVar(store, "rfp_requestforproposalcostos", 0, 300);
		featureAttributes[33][1] = new IntVar(store, "rfp_requestforproposaltiempo", 0, 0);
		featureAttributes[33][2] = new IntVar(store, "rfp_requestforproposalrecursoshumanos", 0, 0);
		featureAttributes[33][3] = new IntVar(store, "rfp_requestforproposalriesgos", 0, 8);

		featureAttributes[34][0] = new IntVar(store, "consultoriaexternacostos", 0, 100000);
		featureAttributes[34][1] = new IntVar(store, "consultoriaexternatiempo", 0, 0);
		featureAttributes[34][2] = new IntVar(store, "consultoriaexternarecursoshumanos", 0, 0);
		featureAttributes[34][3] = new IntVar(store, "consultoriaexternariesgos", 0, 11);

		featureAttributes[35][0] = new IntVar(store, "evaluacioninternacostos", 0, 500);
		featureAttributes[35][1] = new IntVar(store, "evaluacioninternatiempo", 0, 0);
		featureAttributes[35][2] = new IntVar(store, "evaluacioninternarecursoshumanos", 0, 0);
		featureAttributes[35][3] = new IntVar(store, "evaluacioninternariesgos", 0, 34);

		featureAttributes[29][0].addDom(0, 0);
		featureAttributes[29][0].addDom(650, 650);
		featureAttributes[29][0].addDom(700, 700);
		featureAttributes[29][0].addDom(800, 800);
		
		featureAttributes[31][0].addDom(0, 0);
		featureAttributes[31][0].addDom(450, 450);
		featureAttributes[31][0].addDom(500, 500);
		
		featureAttributes[30][0].addDom(0, 0);
		featureAttributes[30][0].addDom(800, 800);
		featureAttributes[30][0].addDom(950, 950);
		...
		BooleanVar[] varsXor1 = new BooleanVar[4];
		...
		store.impose(new IfThen(new XeqC(mantenimiento, 1), new XeqC(inversionti, 1)));
		store.impose(new IfThen(new XeqC(inversionti, 0), new XeqC(mantenimiento, 0)));
		store.impose(new IfThen(new XeqC(modelodeseleccion, 1), new XeqC(inversionti, 1)));
		store.impose(new IfThen(new XeqC(inversionti, 0), new XeqC(modelodeseleccion, 0)));
		...
		store.impose(new IfThen(new XeqC(contratoconelproveedor, 1), new XeqC(mantenimiento, 1)));
		store.impose(new IfThen(new XeqC(mantenimiento, 0), new XeqC(contratoconelproveedor, 0)));
		store.impose(new IfThen(new XeqC(contratoconunproveedorespecializado, 1), new XeqC(mantenimiento, 1)));
		store.impose(new IfThen(new XeqC(mantenimiento, 0), new XeqC(contratoconunproveedorespecializado, 0)));
		store.impose(new IfThen(new XeqC(mantenimientoporcuentapropia, 1), new XeqC(mantenimiento, 1)));
		store.impose(new IfThen(new XeqC(mantenimiento, 0), new XeqC(mantenimientoporcuentapropia, 0)));
		store.impose(new IfThen(new XeqC(sincontratodemantenimiento, 1), new XeqC(mantenimiento, 1)));
		store.impose(new IfThen(new XeqC(mantenimiento, 0), new XeqC(sincontratodemantenimiento, 0)));
		store.impose(new IfThen(new XeqC(rfp_requestforproposal, 1), new XeqC(modelodeseleccion, 1)));
		store.impose(new IfThen(new XeqC(modelodeseleccion, 0), new XeqC(rfp_requestforproposal, 0)));
		store.impose(new IfThen(new XeqC(consultoriaexterna, 1), new XeqC(modelodeseleccion, 1)));
		store.impose(new IfThen(new XeqC(modelodeseleccion, 0), new XeqC(consultoriaexterna, 0)));
		store.impose(new IfThen(new XeqC(evaluacioninterna, 1), new XeqC(modelodeseleccion, 1)));
		store.impose(new IfThen(new XeqC(modelodeseleccion, 0), new XeqC(evaluacioninterna, 0)));
		...
		store.impose(new IfThen(new XeqC(contratoconelproveedor, 0), new XeqC(featureAttributes[29][0], 0)));
		store.impose(new IfThen(new XeqC(contratoconelproveedor, 0), new XeqC(featureAttributes[29][1], 0)));
		store.impose(new IfThen(new XeqC(contratoconelproveedor, 0), new XeqC(featureAttributes[29][2], 0)));
		store.impose(new IfThen(new XeqC(contratoconelproveedor, 0), new XeqC(featureAttributes[29][3], 0)));

		store.impose(new IfThen(new XeqC(contratoconunproveedorespecializado, 0), new XeqC(featureAttributes[30][0], 0)));
		store.impose(new IfThen(new XeqC(contratoconunproveedorespecializado, 0), new XeqC(featureAttributes[30][1], 0)));
		store.impose(new IfThen(new XeqC(contratoconunproveedorespecializado, 0), new XeqC(featureAttributes[30][2], 0)));
		store.impose(new IfThen(new XeqC(contratoconunproveedorespecializado, 0), new XeqC(featureAttributes[30][3], 0)));

		store.impose(new IfThen(new XeqC(sincontratodemantenimiento, 0), new XeqC(featureAttributes[32][0], 0)));
		store.impose(new IfThen(new XeqC(sincontratodemantenimiento, 0), new XeqC(featureAttributes[32][1], 0)));
		store.impose(new IfThen(new XeqC(sincontratodemantenimiento, 0), new XeqC(featureAttributes[32][2], 0)));
		store.impose(new IfThen(new XeqC(sincontratodemantenimiento, 0), new XeqC(featureAttributes[32][3], 0)));

		store.impose(new IfThen(new XeqC(consultoriaexterna, 0), new XeqC(featureAttributes[34][0], 0)));
		store.impose(new IfThen(new XeqC(consultoriaexterna, 0), new XeqC(featureAttributes[34][1], 0)));
		store.impose(new IfThen(new XeqC(consultoriaexterna, 0), new XeqC(featureAttributes[34][2], 0)));
		store.impose(new IfThen(new XeqC(consultoriaexterna, 0), new XeqC(featureAttributes[34][3], 0)));

		store.impose(new IfThen(new XeqC(evaluacioninterna, 0), new XeqC(featureAttributes[35][0], 0)));
		store.impose(new IfThen(new XeqC(evaluacioninterna, 0), new XeqC(featureAttributes[35][1], 0)));
		store.impose(new IfThen(new XeqC(evaluacioninterna, 0), new XeqC(featureAttributes[35][2], 0)));
		store.impose(new IfThen(new XeqC(evaluacioninterna, 0), new XeqC(featureAttributes[35][3], 0)));

		BooleanVar[] selectVars = new BooleanVar[43];
		selectVars[0] = inversionti;
		selectVars[1] = motivadoresdenegocio;
		selectVars[2] = sistemasempresariales;
		selectVars[3] = mantenimiento;
		selectVars[4] = modelodeseleccion;
		...
		selectVars[36] = contratoconelproveedor;
		selectVars[37] = contratoconunproveedorespecializado;
		selectVars[38] = mantenimientoporcuentapropia;
		selectVars[39] = sincontratodemantenimiento;
		selectVars[40] = rfp_requestforproposal;
		selectVars[41] = consultoriaexterna;
		selectVars[42] = evaluacioninterna;
