...
public class Scenario05Team01 {
	public void solveProblem() {
		...
		BooleanVar tipodesolucion = new BooleanVar(store, "tipodesolucion");
		store.impose(new XeqC(tipodesolucion, 1));
		...
		store.impose(new XeqC(disminuirtiemposdeentrega, 1));
		BooleanVar integracionconproveedores = new BooleanVar(store, "integracionconproveedores");
		store.impose(new XeqC(integracionconproveedores, 1));
		...
		BooleanVar comercial = new BooleanVar(store, "comercial");
		store.impose(new XeqC(comercial, 0));
		BooleanVar opensource = new BooleanVar(store, "opensource");
		...
		IntVar[][] featureAttributes = new IntVar[34][4];featureAttributes[0][0] = new IntVar(store, "segmentarydepurarclientescostos", 0, 0);
		...
		featureAttributes[29][0] = new IntVar(store, "comercialcostos", 0, 710750);
		featureAttributes[29][1] = new IntVar(store, "comercialtiempo");
		featureAttributes[29][2] = new IntVar(store, "comercialrecursoshumanos", 0, 0);
		featureAttributes[29][3] = new IntVar(store, "comercialriesgos", 0, 64);

		featureAttributes[30][0] = new IntVar(store, "opensourcecostos", 0, 286000);
		featureAttributes[30][1] = new IntVar(store, "opensourcetiempo");
		featureAttributes[30][2] = new IntVar(store, "opensourcerecursoshumanos", 0, 0);
		featureAttributes[30][3] = new IntVar(store, "opensourceriesgos", 0, 126);

		featureAttributes[31][0] = new IntVar(store, "bigbangcostos", 0, 0);
		featureAttributes[31][1] = new IntVar(store, "bigbangtiempo", 0, 0);
		featureAttributes[31][2] = new IntVar(store, "bigbangrecursoshumanos", 0, 0);
		featureAttributes[31][3] = new IntVar(store, "bigbangriesgos", 0, 55);

		featureAttributes[32][0] = new IntVar(store, "implementacionporfasescostos", 0, 0);
		featureAttributes[32][1] = new IntVar(store, "implementacionporfasestiempo", 0, 0);
		featureAttributes[32][2] = new IntVar(store, "implementacionporfasesrecursoshumanos", 0, 0);
		featureAttributes[32][3] = new IntVar(store, "implementacionporfasesriesgos", 0, 110);

		featureAttributes[33][0] = new IntVar(store, "implementacionporprocesoscostos", 0, 0);
		featureAttributes[33][1] = new IntVar(store, "implementacionporprocesostiempo", 0, 0);
		featureAttributes[33][2] = new IntVar(store, "implementacionporprocesosrecursoshumanos", 0, 0);
		featureAttributes[33][3] = new IntVar(store, "implementacionporprocesosriesgos", 0, 65);

		featureAttributes[29][1].addDom(0, 0);
		featureAttributes[29][1].addDom(24, 24);
		featureAttributes[29][1].addDom(28, 28);
		featureAttributes[29][1].addDom(30, 30);
		
		featureAttributes[30][1].addDom(0, 0);
		featureAttributes[30][1].addDom(30, 30);
		featureAttributes[30][1].addDom(36, 36);
		...
		store.impose(new IfThen(new XeqC(tipodesolucion, 1), new XeqC(inversionti, 1)));
		store.impose(new IfThen(new XeqC(inversionti, 0), new XeqC(tipodesolucion, 0)));
		...
		store.impose(new IfThen(new XeqC(comercial, 1), new XeqC(tipodesolucion, 1)));
		store.impose(new IfThen(new XeqC(tipodesolucion, 0), new XeqC(comercial, 0)));
		store.impose(new IfThen(new XeqC(opensource, 1), new XeqC(tipodesolucion, 1)));
		store.impose(new IfThen(new XeqC(tipodesolucion, 0), new XeqC(opensource, 0)));
		...
		store.impose(new IfThen(new XeqC(comercial, 0), new XeqC(featureAttributes[29][0], 0)));
		store.impose(new IfThen(new XeqC(comercial, 0), new XeqC(featureAttributes[29][1], 0)));
		store.impose(new IfThen(new XeqC(comercial, 0), new XeqC(featureAttributes[29][2], 0)));
		store.impose(new IfThen(new XeqC(comercial, 0), new XeqC(featureAttributes[29][3], 0)));

		store.impose(new IfThen(new XeqC(implementacionporprocesos, 0), new XeqC(featureAttributes[33][0], 0)));
		store.impose(new IfThen(new XeqC(implementacionporprocesos, 0), new XeqC(featureAttributes[33][1], 0)));
		store.impose(new IfThen(new XeqC(implementacionporprocesos, 0), new XeqC(featureAttributes[33][2], 0)));
		store.impose(new IfThen(new XeqC(implementacionporprocesos, 0), new XeqC(featureAttributes[33][3], 0)));

		BooleanVar[] selectVars = new BooleanVar[41];
		selectVars[0] = inversionti;
		selectVars[1] = motivadoresdenegocio;
		selectVars[2] = sistemasempresariales;
		selectVars[3] = tipodesolucion;
		selectVars[4] = modelodeimplementacion;
		...
		selectVars[36] = comercial;
		selectVars[37] = opensource;
		selectVars[38] = bigbang;
		selectVars[39] = implementacionporfases;
		selectVars[40] = implementacionporprocesos;
		...
		for (int i = 0; i < featureAttributes.length; i ++) {
			varTiempo [i] = featureAttributes[i][0];
			varRiesgos [i] = featureAttributes[i][3];
			
			maxTiempo += featureAttributes[i][0].max();
		...
		SelectChoicePoint<IntVar> select = new SimpleSelect<IntVar>(varTiempo, 
