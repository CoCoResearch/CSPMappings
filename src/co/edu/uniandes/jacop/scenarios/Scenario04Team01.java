...
public class Scenario04Team01 {
	public void solveProblem() {
		...
		featureAttributes[29][0] = new IntVar(store, "contratoconelproveedorcostos");
		...
		featureAttributes[30][0] = new IntVar(store, "contratoconunproveedorespecializadocostos");
		...
		featureAttributes[31][0] = new IntVar(store, "mantenimientoporcuentapropiacostos");
