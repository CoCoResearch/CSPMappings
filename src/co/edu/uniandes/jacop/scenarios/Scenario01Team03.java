...
public class Scenario01Team03 {
	public void solveProblem() {
		...
		store.impose(new IfThen(new XeqC(adaptarsistemaexistente, 0), new XeqC(featureAttributes[30][0], 0)));
		store.impose(new IfThen(new XeqC(adaptarsistemaexistente, 0), new XeqC(featureAttributes[30][1], 0)));
		store.impose(new IfThen(new XeqC(adaptarsistemaexistente, 0), new XeqC(featureAttributes[30][2], 0)));
		store.impose(new IfThen(new XeqC(adaptarsistemaexistente, 0), new XeqC(featureAttributes[30][3], 0)));

		store.impose(new IfThen(new XeqC(subcontratarpersonalizacion, 0), new XeqC(featureAttributes[31][0], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpersonalizacion, 0), new XeqC(featureAttributes[31][1], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpersonalizacion, 0), new XeqC(featureAttributes[31][2], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpersonalizacion, 0), new XeqC(featureAttributes[31][3], 0)));

		store.impose(new IfThen(new XeqC(subcontratarpartedeldesarrolloeintegracion, 0), new XeqC(featureAttributes[32][0], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpartedeldesarrolloeintegracion, 0), new XeqC(featureAttributes[32][1], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpartedeldesarrolloeintegracion, 0), new XeqC(featureAttributes[32][2], 0)));
		store.impose(new IfThen(new XeqC(subcontratarpartedeldesarrolloeintegracion, 0), new XeqC(featureAttributes[32][3], 0)));
