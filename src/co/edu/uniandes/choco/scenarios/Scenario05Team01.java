...
public class Scenario05Team01 {
	public void solveProblem() {
		...
		BoolVar comercial = (BoolVar) VariableFactory.fixed("comercial", 0, solver);
		...
		IntVar[][] featureAttributes = new IntVar[34][4];
		featureAttributes[0][0] = VariableFactory.bounded("segmentarydepurarclientescostos", 0, 0, solver);
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(comercial, "=", 0), IntConstraintFactory.arithm(featureAttributes[29][0], "=", 0));
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(comercial, "=", 0), IntConstraintFactory.arithm(featureAttributes[29][1], "=", 0));
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(comercial, "=", 0), IntConstraintFactory.arithm(featureAttributes[29][2], "=", 0));
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(comercial, "=", 0), IntConstraintFactory.arithm(featureAttributes[29][3], "=", 0));
