...
public class PCParentDeselection {
	...
	public void solveProblem() {
		...
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(A, "=", 0),
				IntConstraintFactory.arithm(A1, "=", 0));
		LogicalConstraintFactory.ifThen(IntConstraintFactory.arithm(A, "=", 0),
				IntConstraintFactory.arithm(A2, "=", 0));
